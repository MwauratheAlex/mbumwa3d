...
func Navbar() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div id=\"navbar-menu\" onclick=\"closeMenu()\" class=\"hidden daisy-navbar items-center justify-end gap-4 w-full md:flex top-9 right-0  md:bg-opacity-0 bg-black transition-all duration-1000 z-[999]\"><div class=\"flex flex-col gap-4 md:flex-row tracking-wide text-gray-800 text-sm\"><div class=\"daisy-dropdown daisy-dropdown-hover\"><div tabindex=\"0\" role=\"button\" class=\"daisy-btn daisy-btn-sm daisy-btn-ghost m-1 tracking-widest font-normal\">My orders</div><ul tabindex=\"0\" class=\"daisy-dropdown-content daisy-menu bg-base-100 rounded-box z-[1] w-52 p-2 shadow\"><li><a href=\"/orders/processing\" hx-get=\"/orders/processing\" hx-target=\"#content-container\" hx-push-url=\"true\" class=\"tracking-widest\">Processing</a></li><li><a href=\"/orders/complete\" hx-get=\"/orders/complete\" hx-target=\"#content-container\" hx-push-url=\"true\" class=\"tracking-widest\">Complete</a></li></ul></div><a href=\"/shop\" hx-get=\"/shop\" hx-target=\"#content-container\" hx-push-url=\"true\" class=\"tracking-widest glass font-normal daisy-btn daisy-btn-outline daisy-btn-sm text-gray-800 hover:text-orange-100 hover:bg-gray-950\">Shop models</a></div><div hx-get=\"/usermenu\" hx-trigger=\"load\" id=\"usermenu\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
...
func LoginSignupButton(text string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/views/components/navbar.templ`, Line: 151, Col: 8}
		}
...
func LoggedInUserMenu() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"flex flex-row md:flex-row gap-2 text-gray-900 text-sm\"><a href=\"/dashboard\" hx-get=\"/dashboard\" hx-target=\"#content-container\" hx-push-url=\"true\" class=\"px-4 font-normal tracking-widest py-2 daisy-btn daisy-btn-sm glass bg-gray-950 text-orange-100 hover:bg-green-950\">Dashboard</a> <a hx-post=\"/logout\" hx-target=\"#usermenu\" hx-swap=\"innerHTML\" class=\"text-gray-800 font-normal pl-4 pr-4 pt-2 pb-2 daisy-btn daisy-btn-ghost daisy-btn-sm\">Logout</a></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
