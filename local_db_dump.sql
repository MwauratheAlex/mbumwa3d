...
COPY public.cart_orders (cart_id, order_id) FROM stdin;
\.
...
COPY public.orders (id, user_id, file_id, inserted_at, updated_at, build_time, quantity, price, phone, payment_complete, status, print_status, printer_id) FROM stdin;
27	98	58	2024-07-04 09:01:16	2024-07-05 13:24:07	72	1	46.736343011271096		f	Reviewing	Selected	98
28	98	63	2024-07-04 09:07:17	2024-07-05 13:43:24	72	1	46.736343011271096		f	Reviewing	Selected	98
33	98	68	2024-07-05 11:47:02	2024-07-05 13:45:03	72	1	46.736343011271096		f	Reviewing	Selected	98
34	98	69	2024-07-05 11:51:58	2024-07-05 13:45:39	72	1	46.736343011271096		f	Reviewing	Selected	98
35	98	70	2024-07-05 11:56:59	2024-07-05 13:47:46	72	1	1223.457307794972	0713958070	f	Reviewing	Selected	98
8	98	63	2024-07-04 09:07:17	2024-07-05 14:02:25	72	1	46.736343011271096	1122334	f	Reviewing	Selected	98
\.
...
ALTER TABLE ONLY public.cart_orders
    ADD CONSTRAINT cart_orders_pkey PRIMARY KEY (cart_id, order_id);
...
--
-- Name: cart_orders cart_orders_cart_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cart_orders
    ADD CONSTRAINT cart_orders_cart_id_fkey FOREIGN KEY (cart_id) REFERENCES public.carts(id) ON DELETE CASCADE;


--
-- Name: cart_orders cart_orders_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cart_orders
    ADD CONSTRAINT cart_orders_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;
